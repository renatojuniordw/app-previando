  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/lib/cause-value-engine.ts', 'src/lib/bpc-notes.ts',
        'src/lib/cnis-status.ts', 'src/lib/rate-limit.ts',
        'src/lib/pdf-generator.ts', 'src/lib/modalidades.ts',
        'src/lib/sanitize-server.ts', 'src/lib/audit-hash.ts',
        'src/store/**/*.ts',
