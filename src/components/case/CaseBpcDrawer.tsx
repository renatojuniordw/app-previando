          ...
          <div className="space-y-3">
            {[1, 2].map((i) => (
              <div key={i} className="bg-[var(--color-card-bg)] border border-[var(--color-border)] rounded-xl p-4 animate-pulse">
                <div className="h-3 w-32 bg-[var(--color-card-inner)] rounded mb-2" />
              ...
              return (
                <Card key={section.key} variant="light" className="p-0 overflow-hidden">
                  <button
                    ...
                    className="w-full flex align-items-center justify-content-between px-4 py-3 text-left hover:bg-[var(--color-surface)] transition-colors"
                  >
                    <div className="flex align-items-center gap-2">
                  ...
                  {isOpen && (
                    <div className="border-t border-[var(--color-border)]">
                      ...
                      <div className="border-t border-[var(--color-border)] bg-transparent px-4 py-2 flex gap-2">
                        <button
