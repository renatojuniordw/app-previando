                  ...
                  <tr key={user.id} className="hover:bg-slate-50 transition-colors">
                    <td className="px-5 py-4">
                      <div className="flex align-items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-slate-100 flex align-items-center justify-content-center text-slate-600 font-bold text-sm shrink-0">
                    ...
                    <td className="px-5 py-4">
                      <select
                        ...
                        className="text-xs bg-white border border-slate-200 rounded-lg px-2 py-1.5 text-slate-700 font-medium focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/20 focus:border-[var(--color-primary)]"
                      >
                        <option value="FREE">FREE</option>
                        <option value="SOLO">SOLO</option>
                        <option value="PRO">PRO</option>
                    ...
                    <td className="px-5 py-4 text-right">
                      <span
                        ...
                        className={`inline-flex align-items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg cursor-pointer transition-colors ${
