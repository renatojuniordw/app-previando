    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card variant="light" className="p-6">
          <div className="flex align-items-center gap-2 text-slate-500 mb-4">
            <DollarSign className="w-5 h-5" />
            <h3 className="font-serif font-bold text-lg text-slate-900">Receita</h3>
          </div>
          <div className="space-y-4">
            <div className="flex align-items-center justify-content-between pb-3 border-b border-slate-100">
              <span className="text-sm text-slate-500 font-medium">MRR</span>
              <span className="font-bold text-xl text-[var(--color-primary)]">{formatBRL(metrics.revenue.mrr)}</span>
            </div>
            <div className="flex align-items-center justify-content-between pb-3 border-b border-slate-100">
        ...
        <Card variant="light" className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex align-items-center justify-content-between pb-3 border-b border-slate-100">
              ...
              <span className="font-bold text-lg text-[var(--color-primary)]">{metrics.users.newThisMonth}</span>
            </div>
            <div className="space-y-2">
              {['FREE', 'SOLO', 'PRO'].map((plan) => (
                <div key={plan} className="flex align-items-center justify-content-between text-sm">
        ...
        <Card variant="light" className="p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex align-items-center justify-content-between">
              ...
              <span className={`font-bold text-lg ${metrics.usage.aiCostThisMonthUsd > 10 ? 'text-[var(--color-primary)]' : 'text-slate-900'}`}>
